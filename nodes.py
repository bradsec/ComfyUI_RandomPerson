...
_FOOTWEAR_LABELS    = ["(none)"] + _union(_labels(load_sex("male", "footwear.json")),
                                          _labels(load_sex("female", "footwear.json")))
...
CATEGORY_SPECS = [
    ...
    ("footwear",     _FOOTWEAR_LABELS,     "e.g. sneakers, boots, sandals, heels"),
]
...
SEX_GATED = {"hair_color", "hair_style", "hair_length", "body_type", "face_shape",
             ...
             "shoulders", "chest", "bust_size", "bust_shape", "clothing", "footwear"}
...
RETURN_NAMES = ("description", "sex", "age", "nationality", "complexion",
                ...
                "expression", "accessories", "makeup",
                "shoulders", "chest", "bust", "clothing", "footwear", "seed")
...
def generate_person(seed, randomize, sex, category_args,
    ...
    description = build_description(
        ...
        clothing=p["clothing"], footwear=p["footwear"])
    ...
    return (description, resolved_sex, out_age, out_nat, out_comp,
            ...
            dd("shoulders"), dd("chest"), out_bust, dd("clothing"), dd("footwear"), seed)
...
NODE_SPECS = [
    ...
    ("RandomPersonStyle", "Random Person: Style",
     ["clothing", "accessories", "makeup", "footwear"], False,
     ("description", "sex", "clothing", "accessories", "makeup", "footwear", "seed")),
]
    ...
    class _RandomPersonV1:
        ...
        def INPUT_TYPES(cls):
            ...
            required["extra_attributes"] = ("STRING", {"default": "", "multiline": True,
                                                       "placeholder": "Add any extra details to pass into the description, e.g. wearing a red scarf, holding a coffee, tattoo on left arm",
                                                       "tooltip": _EXTRA_TIP})
